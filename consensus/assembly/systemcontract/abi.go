...
const ValidatorsInteractiveABI = `[
  ...
  {
    "inputs": [],
    "name": "countStakedActiveValidator",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
...
`
  ...
  const CMDInteractiveABI = `[
    {
      "inputs": [],
      "name": "adjustRemainderMine",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
  ...
  const MinerInteractiveABI = `[
      ...
      "outputs": [
        {
          ...
          "internalType": "struct Miner.ChequeInfo",
          "name": "",
          "type": "tuple"
        }
      ],
      ...
      "outputs": [
        {
          "components": [
            ...
            {
              "internalType": "uint256",
              "name": "latestReleaseUnStakedTime",
              "type": "uint256"
            },
            {
              "internalType": "uint256",
    ...
    },
    {
      ...
      "name": "modifyMinimumMinerStakeCoin",
      "outputs": [],
      "stateMutability": "nonpayable",
      "type": "function"
    },
...
const ValidatorsV2InteractiveABI = `[
  ...
  },
  {
    ...
    "name": "LogRemoveValidatorStakedCoin",
    "type": "event"
  },
  {
    "anonymous": false,
...
const ProposalV2InteractiveABI = `[
  {
    "anonymous": false,
    "inputs": [
      {
  ...
  {
    "inputs": [],
    "name": "transferAllBackToFoundation",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
...
var (
	...
	// StakerContractName       = "staker"
  CMDContractName          = "cmd"
  ReleaseContractName      = "release"
  MinerContractName        = "miner"
  ValidatorsV2ContractName = "vlidators_v2"
  PunishV2ContractName     = "punish_v2"
  ProposalV2ContractName   = "proposal_v2"
  CMDV2ContractName        = "Cmd_V2"
	...
	MinerContractAddr        = common.HexToAddress("0x000000000000000000000000000000000000F003")

  ValidatorsV2ContractAddr = common.HexToAddress("0x000000000000000000000000000000000000F004")
  PunishV2ContractAddr     = common.HexToAddress("0x000000000000000000000000000000000000F005")
  ProposalV2ContractAddr   = common.HexToAddress("0x000000000000000000000000000000000000F006")
  CMDV2ContractAddr        = common.HexToAddress("0x000000000000000000000000000000000000F007")

	CMDContractAddr          = common.HexToAddress("0x000000000000000000000000000000000000A002")
	ReleaseContractAddr      = common.HexToAddress("0x000000000000000000000000000000000000a001")
...
func init() {
	...
	abiMap[ProposalContractName] = tmpABI
  	...
  	tmpABI, _ = abi.JSON(strings.NewReader(CMDInteractiveABI))
	abiMap[CMDContractName] = tmpABI

  	tmpABI, _ = abi.JSON(strings.NewReader(ReleaseInteractiveABI))
  	abiMap[ReleaseContractName] = tmpABI

  	tmpABI, _ = abi.JSON(strings.NewReader(MinerInteractiveABI))
  	abiMap[MinerContractName] = tmpABI

    tmpABI, _ = abi.JSON(strings.NewReader(ValidatorsV2InteractiveABI))
  	abiMap[ValidatorsV2ContractName] = tmpABI
    tmpABI, _ = abi.JSON(strings.NewReader(PunishV2InteractiveABI))
  	abiMap[PunishV2ContractName] = tmpABI
    tmpABI, _ = abi.JSON(strings.NewReader(ProposalV2InteractiveABI))
  	abiMap[ProposalV2ContractName] = tmpABI

    tmpABI, _ = abi.JSON(strings.NewReader(CMDV2InteractiveABI))
    abiMap[CMDV2ContractName] = tmpABI
...
func GetCMDContractAddress() *common.Address{
  return &CMDContractAddr
}
